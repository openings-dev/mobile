...
export function ActionButton({ icon, label, onPress, primary }: ActionButtonProps): React.ReactNode {
  ...
  return (
    <Pressable accessibilityRole="button" className={primary ? "min-h-11 flex-row items-center justify-center gap-2 rounded-pill bg-primary px-4" : "min-h-11 flex-row items-center justify-center gap-2 rounded-control border border-line bg-paper px-4"} onPress={onPress}>
